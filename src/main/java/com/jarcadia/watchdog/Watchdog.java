...
public class Watchdog {
    ...
    public static WatchdogManager init(RedisClient redisClient, RedisCommando rcommando, String packageName) {
        ...
        recruiter.registerTaskHandlerAnnotation(WatchdogInstanceDiscoveryHandler.class,
        		(clazz, method, annotation) -> "discover.instances.impl");
        recruiter.registerTaskHandlerAnnotation(WatchdogGroupDiscoveryHandler.class,
        		(clazz, method, annotation) -> "discover.groups.impl");
        recruiter.registerTaskHandlerAnnotation(WatchdogArtifactDiscoveryHandler.class,
        		(clazz, method, annotation) -> "discover.artifacts.impl");
        recruiter.registerTaskHandlerAnnotation(WatchdogInstancePatrol.class,
       		(clazz, method, annotation) -> "patrol.instance." + clazz.getSimpleName() + "." + method.getName());
        recruiter.registerTaskHandlerAnnotation(WatchdogGroupPatrol.class,
